    ...
    <div class="py-8 max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-sm sm:rounded-lg p-6">
            <form method="POST" action="{{ route('users.store') }}">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Potvrda lozinke</label>
                ...
                <div class="mb-6">
                    ...
                    <select name="role" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <option value="engineer" @selected(old('role') === 'engineer')>Inženjer</option>
                        <option value="client" @selected(old('role') === 'client')>Klijent</option>
                    </select>
                    @error('role')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
